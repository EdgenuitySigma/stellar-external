...
namespace KeyAuth {
	...
	public:
		...
		void nehiri();  // init
		void seviyorum(); // check 
		void log(std::string msg);
		void nehirseviselim(std::string key); // license
		...
		void nehirsarilalim(std::string username, std::string password);  // login
